  ...
  <div class="datepicker-picker inline-block rounded-lg bg-white dark:bg-gray-700 shadow-lg p-4">
    ...
    <div class="datepicker-footer">
      <div class="datepicker-controls flex space-x-2 mt-2">
        <button type="button" class="%buttonClass% today-btn text-white bg-amber-500 dark:bg-amber-500 hover:bg-amber-800 dark:hover:bg-amber-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 text-center w-1/2"></button>
...
class DaysView extends View {
  ...
  render() {
    ...
    Array.from(this.grid.children).forEach((el, index) => {
      ...
      if (this.selected.includes(current)) {
        classList.add('selected', 'bg-amber-500', 'text-white', 'dark:bg-amber-500', 'dark:text-white');
  ...
  refresh() {
    ...
    this.grid
      ...
      .forEach((el) => {
        el.classList.remove('range', 'range-start', 'range-end', 'selected', 'bg-amber-500', 'text-white', 'dark:bg-amber-500', 'dark:text-white', 'focused');
...
class MonthsView extends View {
  ...
  refresh() {
    ...
    this.grid
      .querySelectorAll('.range, .range-start, .range-end, .selected, .focused')
      .forEach((el) => {
        el.classList.remove('range', 'range-start', 'range-end', 'selected', 'bg-amber-500', 'dark:bg-amber-500', 'dark:text-white', 'text-white', 'focused');
